  ...
  return (
    <div className="w-full h-screen bg-[#F1F1F1]">
      ...
      <div className="bg-[#FFFFFF] w-full h-[62px] flex items-center justify-center">
        <div className="w-[350px] h-[29px] bg-[#E6FAF0] rounded-[10px] flex items-center">
      ...
      <div className="w-full flex flex-col gap-y-[10px] items-center">
        <div className="w-[350px] flex items-start"><span className="text-[#000000] font-medium leading-[37.2px] text-[24px] font-laila">Yo'nalishlar</span></div>
        <div className="bg-[#FFFFFF] w-[350px] h-[187px] p-[15px]">
          <div>
            <div className="flex items-center justify-between">
